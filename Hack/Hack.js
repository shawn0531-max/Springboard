...
// open form to submit new story
  $navNewStory.on('click',function(e){
    toggleStoryForm();
  })

  // show my stories
  $nav.on("click", "#nav-myStories", function() {
    hideElements();
    if (currentUser) {
      $userProfile.hide();
      generateMyStories();
  ...
  function showNavForLoggedInUser() {
    ...
    const $userName = $("#nav-user-profile");
    $userName.html(user);
